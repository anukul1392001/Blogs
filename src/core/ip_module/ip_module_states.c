...
void
ip_state_init_entry(void *smObj)
{
}


smf_state_result_t
ip_state_init_run(void *smObj)
{
...
void
ip_state_connecting_entry(void *smObj)
{
}


smf_state_result_t
ip_state_connecting_run(void *smObj)
{
    return (SM_EVENT_HANDLED);
}
...
void
ip_state_connecting_exit(void *smObj)
{
}


void
ip_state_connected_entry(void *smObj)
{
}


smf_state_result_t
ip_state_connected_run(void *smObj)
{
    return (SM_EVENT_HANDLED);
}
...
void
ip_state_connected_exit(void *smObj)
{
}


void
ip_state_disconnected_entry(void *smObj)
{
}


smf_state_result_t
ip_state_disconnected_run(void *smObj)
{
    return (SM_EVENT_HANDLED);
}
...
void
ip_state_disconnected_exit(void *smObj)
{
}


void
ip_state_failed_entry(void *smObj)
{
}


smf_state_result_t
ip_state_failed_run(void *smObj)
{
    return (SM_EVENT_HANDLED);
}